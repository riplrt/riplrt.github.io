...
<div style="text-align:justify"><p>In the RIPLRT, Naziba looks forward to get immerse into the different epicycles of science, including learning the different laboratory techniques we employ as well as being guided in the different areas we <a href="https://www.riplrt.com/mentoring/" target="_blank">mentor</a>.</p></div>
...
<div style="text-align:justify"><p>In the RIPLRT, Tanha looks forward to expand her previous research experience, and be involved with our effots to address the respiratory health among minority groups and sections of society with high prevalence of respiratory conditions.</p></div>
